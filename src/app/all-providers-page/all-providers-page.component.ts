...
@Component({
  ...
  standalone: true,
  imports: [NgIf,NgForOf,CurrencyPipe,ResubaleNavbarComponent],
  templateUrl: './all-providers-page.component.html'
})
export class AllProvidersPageComponent implements OnInit {
  constructor(private serviceDetailService:ServiceDetailService,private bookingDataService:BookingServiceService,
...
bookProvider(cost:number,name:string): void {
